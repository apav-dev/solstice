...
export default function useInitialSearch(config?: InitialSearchConfig) {
  ...
  useLayoutEffect(() => {
    verticalKey ? answersActions.setVertical(verticalKey) : answersActions.setUniversal();
    ...
    const executeQuery = async () => {
      ...
      queryParam != null ? answersActions.setQuery(queryParam) : answersActions.setQuery(defaultInitialSearch);
