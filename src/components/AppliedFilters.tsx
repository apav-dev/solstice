...
const builtInCssClasses: AppliedFiltersCssClasses = {
  ...
  nlpFilter: 'border rounded-3xl px-3 py-1.5 sm:text-sm font-medium italic mr-2',
  removableFilter: 'flex items-center border rounded-3xl px-3 py-1.5 sm:text-sm font-medium text-gray-900 mr-2',
