...
const builtInCssClasses: FilterSearchCssClasses = {
  container: 'mb-2',
  label: 'mb-4 sm:text-sm font-medium text-gray-900',
  dropdownContainer: 'absolute z-10 shadow-lg rounded-md border border-gray-300 bg-white pt-3 pb-1 px-4 mt-1',
  inputElement:
    'sm:text-sm bg-white outline-none h-9 w-full p-2 rounded-md border border-gray-300 focus:border-blue-600',
  sectionContainer: 'pb-2',
  sectionLabel: 'sm:text-sm text-gray-700 font-semibold pb-2',
  focusedOption: 'bg-gray-100',
  option: 'sm:text-sm text-gray-700 pb-1 cursor-pointer',
};
...
export default function FilterSearch({
  ...
  const [filterSearchResponse, executeFilterSearch] = useSynchronizedRequest<string, FilterSearchResponse>(
