    ...
    <div className={containerClassNames}>
      ...
      {verticalSuggestions && (
        <div className={cssClasses.suggestions}>
          ...
          <ul className={cssClasses.suggestionList}>{verticalSuggestions.map(renderSuggestion)}</ul>
  ...
  function renderNoResultsInfo() {
    return (
      <div className={cssClasses.noResultsText}>
        ...
        {isShowingAllResults && <span> Showing all {currentVerticalLabel} instead.</span>}
      </div>
    );
  }
